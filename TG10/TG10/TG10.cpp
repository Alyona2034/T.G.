...
#include <algorithm>
#include <string>
#include "algFF.cpp"		// Заголовок алгоритма
...
int main() {
	...
	while (true)
	{
		...
		{
			cout << "-----------------------Справка------------------------" << endl;
			cout << "Работу выполнили студенты М3О-219Бк-21 Кожихова А.А. и Ампилова А.А." << endl;
			cout << "------------------------------------------------------" << endl;
			cout << "-h : Вызов справки" << endl;
			cout << "-l : Способ задания графа - список смежности" << endl;
			cout << "-e : Способ задания графа - список рёбер" << endl;
			cout << "-m : Способ задания графа - матрица смежности" << endl;
			cout << "-o : Вывод результата в файл" << endl;
			cout << "-----------------------------------------------------" << endl << endl;
			continue;
		}
